...
let activePlayer = 'X';
//This arrary stores an array of moves. We use this to determine win conditions.
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    function computersTurn() {
        ...
        while(!success) {
            ...
            //If the random number evaluates returns trye, the square hasn't been selected yet.
...
//drawWinLine function is called to draw line if conditions are met.
...
//This function takes a string parament of the the path you set earlier for the
//placement sound ('./media/place.mp3')
function audio(audioURL) {
    //We create a new audio object and we pass the path as a parament.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        y2 = coordY2,
        //This variable stores temporary x asix data we update in our animation loop.
        x = x1,
        //This variable stores temporary y axis data we update in our animation loop.
        y = y1;
    //This function interacts with the canvas
    function animateLineDrawing() {
        //This variable creates the loop for when the games ends and restarts.
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (x < x2) { x += 10; }
            //This conditoin adds 10 to the previous end y point.
            if (y < y2) { y += 10; }
    ...
    //then clears canvas, resets games, and allows clicking again.
    setTimeout(function () { clear(); resetGame(); }, 1000);
}

//This function resets the game in a tie or a wine.
function resetGame() {
